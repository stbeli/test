...
class ExtrasTest extends \Codeception\TestCase\WPTestCase {
	...
	private function make_instance() {
		return new \WooCommerce_Postal_codes_validation\Frontend\Extras\Body_Class();
	}
	...
	public function it_should_add_body_class() {
		...
		$this->assertEquals( array_merge($list, array(WPCV_TEXTDOMAIN)), $sut->add_wpcv_class($list) );
	}
}
